...
class VideoCamera(object):
    ...
    # returnt camera frames met omgrenzende lijnen rond gezicht en predicties
    def get_frame(self):
        ...
        for (x, y, w, h) in faces:
            ...
            # Eerst laden we bestaande data in een dictionairy.
                file_data = json.load(file)
                # nieuwe data bij file_data steken
                file_data.update(y)
                # zet de file bij offset.
                file.seek(0)
